...
export type ProductArticle = {
  age: string;
  consumption_age?: string | null;
  date_created?: string | null;
  date_updated?: string | null;
  facebook?: string | null;
  first_uses_image?: string | DirectusFiles | null;
  first_uses_text?: string | null;
  fourth_uses_image?: string | DirectusFiles | null;
  fourth_uses_text?: string | null;
  id: number;
  ingredient: string;
  lazada?: string | null;
  main_ingredient?: string | DirectusFiles | null;
  main_photo?: string | DirectusFiles | null;
  main_uses_image?: string | DirectusFiles | null;
  main_video_link?: string | null;
  mineral_ingredient?: string | DirectusFiles | null;
  product_id?: number | Product | null;
  product_qnas: any[] | ProductQna[];
  second_uses_image?: string | DirectusFiles | null;
  second_uses_text?: string | null;
  sendo?: string | null;
  shop: string;
  shopee?: string | null;
  slug?: string | null;
  ...
  third_uses_image?: string | DirectusFiles | null;
  third_uses_text?: string | null;
  user_created?: string | DirectusUsers | null;
  user_manual?: string | DirectusFiles | null;
  user_updated?: string | DirectusUsers | null;
  uses: string;
  uses_summary?: string | null;
  vitamin_ingredient?: string | DirectusFiles | null;
};
...
export type ProductQna = {
  ...
  date_updated?: string | null;
  id: number;
  image_answer?: string | DirectusFiles | null;
  product_article_id?: number | ProductArticle | null;
